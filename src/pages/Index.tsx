        ...
        <div className="container relative z-10 py-20">
          ...
          >
            ...
            <p className="mt-5 text-lg text-primary-foreground/80 max-w-md">
              Level Up combina tecnología, nutrición y bienestar para que llegues más lejos cada día.
            </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="mt-4 text-muted-foreground text-lg leading-relaxed">
              En Level Up somos un equipo apasionado por la ciencia, la innovación y la nutrición inteligente.
